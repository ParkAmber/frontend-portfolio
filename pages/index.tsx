        ...
        <div className='work-contents'>
          ...
          <div className='work-imgs-item'> 
              ...
              <span data-progress="45"></span>
                ...
                <p>
                <span>Languages &amp; Frameworks: </span><br/>  HTML<br/>CSS<br/>Styled Components<br /> React<br/>
                </p>
          ...
          <div className='work-imgs-item'>
              ...
              <span data-progress="45"></span>
                 ...
                 <p>
                <span>Languages &amp; Frameworks: </span><br/>  
                HTML<br/>CSS<br/>Styled Components<br /> React<br/>
                </p>
                <span className='button'>
          ...
          <div className='work-imgs-item'>
              ...
              <span data-progress="45"></span>
                ...
                {/* <span className='button'>
                 ...
                 <p>
                <span>Languages &amp; Frameworks: </span><br/>  HTML / CSS / React<br/>Styled Components<br/>Next.js<br/>GraphQL
                </p>
          ...
          <div className='work-imgs-item'>
            ...
            <div className='hover-display center'>
              ...
              <span data-progress="45"></span>
                ...
                <p>
                  <span>Languages &amp; Frameworks: </span><br />  HTML / CSS / React <br/>Styled Components<br />
                  Next.js<br />GraphQL<br />Nest.js<br/>Node.js<br/>
                </p>
                <span className='button'>
